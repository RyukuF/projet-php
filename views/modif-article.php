...
<form method="post">
    ...
    <div class="form-group row">
        ...
        <div class="col-12">
            <input type="text" class="form-control" name="auteur" id="auteur" placeholder="Nom de l'auteur" autofocus>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-12">
            <input type="url" class="form-control" name="image" id="image" placeholder="https://upload.wikimedia.org/wikipedia/commons/thumb/8/89/Wolf_at_Woburn_Safari_Park.jpg/1280px-Wolf_at_Woburn_Safari_Park.jpg">
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-12">
            <textarea class="form-control" name="contenu" id="contenu" placeholder="Ecrivez votre article !" rows="8" cols="148"></textarea>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-12">
            <input type="date" class="form-control" name="date" id="date" value="1970-01-01T00:00:00"></textarea>
        </div>
    </div>
