...
<form method="post">
    ...
    <div class="form-group row">
        ...
        <div class="col-12">
            <input type="text" class="form-control" name="auteur" id="auteur" placeholder="Nom de l'auteur" required autofocus>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-12">
            <input type="url" class="form-control" name="image" id="image" placeholder="https://upload.wikimedia.org/wikipedia/commons/thumb/8/89/Wolf_at_Woburn_Safari_Park.jpg/1280px-Wolf_at_Woburn_Safari_Park.jpg" required>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-12">
            <textarea class="form-control" name="contenu" id="contenu" placeholder="Ecrivez votre article !" rows="8" cols="148" required></textarea>
        </div>
    </div>
